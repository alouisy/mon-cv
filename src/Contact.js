    ...
    return (
        <div className="contact-container">
            ...
            <div className="contact-list">
                ...
                <h2><a className="contact-link" href="https://www.linkedin.com/in/axel-louisylouis/" target="_blank" rel="noopener noreferrer"><i className="fab fa-linkedin"></i> linkedin.com/in/axel-louisylouis</a></h2>
                ...
                {/* <h2><a className="contact-link" href="https://www.linkedin.com/in/axel-louisylouis/" target="_blank" rel="noopener noreferrer"><i className="fab fa-linkedin"></i> Linkedin</a></h2>
